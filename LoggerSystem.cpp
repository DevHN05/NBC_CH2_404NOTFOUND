...
void LoggerSystem::ShowStory()
{
    ...
    vector<string> StoryLines = {
        ...
        "",
        "수만 명의 플레이어가 가상 세계에 갇혀버렸어.",
        "",
        "GM조차 제어할 수 없는 이 버그들은 시스템 권한을 찬탈해 버그 군단을 만들었지.",
        "",
        "이 버그들은 어째서인지 코드 수정 권한까지 빼앗아버렸어.",
        "",
        "하지만 게임 전체를 망가뜨리진 않았지. 무슨 목적이 있는걸까?",
        "",
        "디버깅을 하기 위해선, 게임의 룰을 따르면서 버그를 제거해야 해.",
        "",
        "",
        "이에 개발팀은 최후의 수단으로 '특수 디버깅 툴'을 장착한 요원을 투입하기로 결정했어.",
        "",
        "그게 바로 나야.",
        "",
        "",
        ...
        "",
        "우리는 게임의 규칙을 따라서 디버깅 툴을 무기 삼아야 해.",
        "",
        "디버깅 툴로 적을 타격해서 코드에 접근해 디버깅을 진행해야 해.",
        "",
        "하지만, 적들은 룰을 무시하는 버그 덩어리들이야.",
        "",
        "그들을 하나하나 제거하며 데이터를 수집하고 레벨을 올리며 전진해,",
        "",
